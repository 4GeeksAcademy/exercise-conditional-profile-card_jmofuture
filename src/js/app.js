...
function render(variables = {}) {
  ...
  // Handle name, role, city, country with default values if null
  let fullName = `${variables.name || "Name"} ${variables.lastName ||
    "Last Name"}`;
  let role = variables.role || "Role";
  let cityCountry = `${variables.city || "City"}, ${variables.country ||
    "Country"}`;

  // Handle social media positions and display
